...
import com.rhnlf.firstsubmission.view.FollowingViewModel
import com.rhnlf.firstsubmission.adapter.MainAdapter
import com.rhnlf.firstsubmission.data.User
import com.rhnlf.firstsubmission.databinding.FragmentFollowingBinding
...
class FollowingFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.followingList.observe(viewLifecycleOwner) { followingList ->
            binding.rvFollowing.adapter = showFragmentRecycler(followingList)
        }
